...
class TicketsUI {
  ...
  showEmptyMsg() {
    ...
    this.container.insertAdjacentHTML('afterend', template);
  }

  static emptyMessageTemplate() {
    return `
    <div class="tickets-empty-res-msg">
      По вашему запросу билетов не найдено.<br/>
      No tickets were found at your request.
    </div>
    `;
  }
  ...
  static ticketTemplate(ticket, currency) {
    ...
    <div class="col s12 m6">
      <div class="card ticket-card" data-flight-id="${ticket.id}">
